...
This is a different strategy than is typically seen in the literature,
where separate bias functions are used for each experimental condition.
...
\ref{fig-pairwise-confmat}) and OVR (figure \ref{fig-ovr-confmat}A)
...
(Figure \ref{fig-psa-confmat}A), though the overall dynamic range of the confusion
